...
//			mb.add(master);
			...
			ImageIcon icon4=new ImageIcon(ClassLoader.getSystemResource("image/icon/icon5.png"));
...
//			mb.add(info);
			...
			ImageIcon icon5=new ImageIcon(ClassLoader.getSystemResource("image/icon/icon4.png"));
...
//			mb.add(user);
			...
			ImageIcon icon7=new ImageIcon(ClassLoader.getSystemResource("image/icon/icon4.png"));
...
//			mb.add(report);
			...
			ImageIcon icon9=new ImageIcon(ClassLoader.getSystemResource("image/icon/icon7.png"));
...
//			mb.add(utility);
			...
			ImageIcon icon10=new ImageIcon(ClassLoader.getSystemResource("image/icon/icon12.png"));
