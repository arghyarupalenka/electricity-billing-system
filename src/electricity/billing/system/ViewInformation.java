...
//		meternumber.setFont(new Font("Tahoma",Font.PLAIN,16));
		add(meternumber);
		
		JLabel lbladdress=new JLabel("Address");
		lbladdress.setBounds(70,200,120,40);
...
//		address.setFont(new Font("Tahoma",Font.PLAIN,16));
		...
		lblcity.setBounds(70,260,120,40);
...
//				System.out.println(name);
		...
		image.setBounds(20, 340, 600, 320);
		add(image);
